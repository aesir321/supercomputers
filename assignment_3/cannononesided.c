...
int main (int argc, char **argv) {
	...
	double *A_shared = NULL, *B_shared = NULL;
	...
	A_shared = (double *) malloc (B_local_block_size * sizeof(double));
	...
	B_shared = (double *) malloc (B_local_block_size * sizeof(double));

	MPI_Win_create(A_shared, A_local_block_size, sizeof(double), MPI_INFO_NULL, MPI_COMM_WORLD, &win_A);
	MPI_Win_create(B_shared, B_local_block_size, sizeof(double), MPI_INFO_NULL, MPI_COMM_WORLD, &win_B);
